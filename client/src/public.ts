...
export function landing(signedIn = false) {
  ...
  return `<div class="public-site">${publicHeader(signedIn)}<main id="main-content"><section class="landing-hero public-width"><div class="landing-copy"><div class="eyebrow"><span class="edition-dot"></span> LE PROCHAIN ENTRETIEN SE PRÉPARE</div><h1>Vous avez<br>l’expérience.<br><em>Trouvez les mots.</em></h1><p class="landing-intro">Un CV ne raconte pas tout. Préparez-vous à expliquer vos choix, défendre vos compétences et parler de vos réalisations.</p><div class="landing-cta">${button("Préparer mon entretien", start, "filled", "arrow_forward")}<a class="method-link" href="#welcome/methode">Découvrir la méthode ${icon("south")}</a></div><div class="landing-facts"><span>${icon("description")} À partir de votre CV</span><span>${icon("pace")} Sans chronomètre</span></div></div><div class="landing-visual"><div class="visual-kicker"><span>LE POSTE QUE VOUS VISEZ.</span><span>LE PARCOURS QUI EST LE VÔTRE.</span></div><div class="landing-illustration">${heroArt()}</div><div class="visual-caption"><span class="caption-line"></span><p>Au-delà du CV,<br><strong>il y a votre façon d’en parler.</strong></p></div><div class="visual-stamp" aria-hidden="true">${brandMark()}</div></div></section><div class="journey-strip public-width" aria-label="Les trois étapes de votre préparation"><span><b>01</b> Votre CV</span>${icon("arrow_right_alt")}<span><b>02</b> Vos réponses</span>${icon("arrow_right_alt")}<span><b>03</b> Votre bilan</span></div><section id="methode" tabindex="-1" class="landing-section public-width"><div class="landing-section-head"><div><div class="eyebrow">LA MÉTHODE</div><h2>Un entretien ne s’improvise pas.<br>Sa préparation peut rester simple.</h2></div><p>De votre CV au bilan, tout se passe dans le même espace. Vous choisissez le poste, le niveau et la longueur de l’entretien.</p></div><div class="method-grid">${[
    [
      "01",
